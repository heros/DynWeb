...
function(
    ...
    return BaseView.extend({
        ...
        render: function() {
            ...
            this.$list.on( 'keyup', 'input[type=text]', $.bind( this.filterHashtag, this ) );
            this.$list.on( 'click', 'button', $.bind( this.searchHashtag, this ) );
        ...
        searchHashtag: function( e ) {
            var btn, li, input, value, url;
            ...
            url = li.data('url'),
            url = url.replace( '__hashtag__', value[0] );
            window.location = url;
        },
