...
var iconCog      = '<svg viewBox="0 0 16 16" class="joms-icon"><use xlink:href="#joms-icon-cog"></use></svg>',
    ...
    canEdit, videoUrl, userId, isRegistered, isOwner, isAdmin, enableProfileVideo, enableReporting;
...
function render( _popup, _id ) {
    ...
    joms.ajax({
        ...
        callback: function( json ) {
            ...
            elem.on( 'click', '.joms-popup__btn-fetch', fetch );
...
function buildHtml( json ) {
    ...
    return [
        ...
        '<div class="joms-popup__optcaption"></div>',
...
function tagStart( e ) {
    ...
    joms.util.videotag.create( e, indices );
