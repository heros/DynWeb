...
var iconCog       = '<svg viewBox="0 0 16 16" class="joms-icon"><use xlink:href="#joms-icon-cog"></use></svg>',
    ...
    canEdit, canTag, albumName, albumUrl, photoUrl, userId, isRegistered, isOwner, isAdmin, enableDownload, enableReporting;
...
function render( _popup, _album, _id ) {
    ...
    joms.ajax({
        ...
        callback: function( json ) {
            ...
            elem.on( 'click', '.joms-js--more-comments', fetchAllComments );
...
function tagStart( e ) {
    ...
    joms.util.phototag.create( e, indices );
...
function updateDropdownHtml( json ) {
    ...
    if ( isOwner || isAdmin ) {
        ...
        html += '<a href="javascript:" class="joms-popup__btn-cover">' + lang.set_as_album_cover + '</a>';
        html += '<a href="javascript:" class="joms-popup__btn-delete">' + lang.delete_photo + '</a>';
        html += '<div class="sep"></div>';
        html += '<a href="javascript:" class="joms-popup__btn-rotate-left">' + lang.rotate_left + '</a>';
        html += '<a href="javascript:" class="joms-popup__btn-rotate-right">' + lang.rotate_right + '</a>';
    } else if ( enableReporting ) {
        html += '<a href="javascript:" class="joms-popup__btn-report">' + lang.report + '</a>';
    }
...
function buildHtml( json ) {
    ...
    if ( !json.error ) {
        ...
        caption    = albumName + ' <span class="joms-popup__optcapindex">' + ( index + 1 ) + ' of ' + list.length + '</span>';
    }
