...
return {
    ...
    /** Photos. */
    photoUpload: function( albumId, groupId ) {
        joms.popup.photo.upload( albumId, groupId );
    },
    ...
    /** Videos. */
    videoAdd: function( groupId ) {
        joms.popup.video.add( groupId );
    },
