        ...
        class CWall
        {
                ...
                if ($wallParam->get('attached_photo_id') > 0) {
                    ...
                    if ($wallParam->get('title')) {
                        ...
                        if (is_object($video)) {
                            ...
                            $paramsHTML .= '<p class="joms-media__desc">' . CStringHelper::trim_words(
                                    $wallParam->get('description')
                                ) . '</p>';
            ...
            public static function formatComment($wall)
            {
                ...
                $commentsHTML .= '<div class="cComment wall-coc-item" id="wall-' . $wall->id . '"><a href="' . CUrlHelper::userLink(
                        $user->id
                    ) . '"><img src="' . $user->getThumbAvatar() . '" alt="" class="wall-coc-avatar" /></a>';
                ...
                $canEdit = ($config->get('wallediting') && $my->id == $wall->post_by) || COwnerHelper::isCommunityAdmin() || $allowRemove;
                ...
                if ($params->get('attached_photo_id') > 0) {
                    ...
                    if ($params->get('title')) {
                        ...
                        if (is_object($video)) {
                            ...
                            $paramsHTML .= '<p class="joms-media__desc reset-gap">' . CStringHelper::trim_words(
