...
class CommunityProfileController extends CommunityBaseController {
    ...
    public function preferences() {
        ...
        if ($method == 'POST') {
            ...
            if (empty($saveSuccess) || !in_array(false, $saveSuccess)) {
                ...
                //$showOnlineStatus = JRequest::getInt('showOnlineStatus', 0);
                $editSuccess = true;
                ...
                $postvars['search_email'] = $searchMail = $jinput->get('search_email', 0, 'NONE'); //JRequest::getVar('search_email');
    ...
    public function privacy() {
        ...
        $mainframe = JFactory::getApplication();
        $mainframe->redirect(CRoute::_('index.php?option=com_community&view=profile&task=preferences&Itemid=435#tab:preferences/privacy', false), '', '');
    }
