...
// no direct access
    ...
    class CommunityPhotosController extends CommunityBaseController
    {
        ...
        public function ajaxGetAlbumURL($albumId, $groupId = '')
        {
            ...
            $albumURL = CRoute::_(
                'index.php?option=com_community&view=photos&task=album&albumid=' . $albumId . '' . $groupURL,
                false
            );
            ...
            if ($jinput->getMethod() == 'POST') {
                ...
                if (empty($saveSuccess) || !in_array(false, $saveSuccess)) {
                    if (empty($albumName)) {
                        ...
                        $url = CRoute::_(
                            'index.php?option=com_community&view=photos&task=album&albumid=' . $album->id . '&userid=' . $my->id . $groupString,
                            false
