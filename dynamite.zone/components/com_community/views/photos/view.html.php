...
if (!class_exists('CommunityViewPhotos')) {
    ...
    class CommunityViewPhotos extends CommunityView {
        ...
        public function display($tpl = null) {
            ...
            $type = ($groupId) ? PHOTOS_GROUP_TYPE : PHOTOS_USER_TYPE;
            ...
            $albumsData = $handler->getAllAlbumData($sortBy);
...
//		$friends	= $model->getFriends( $this->my->id , '' , false );
            ...
            switch ($task) {
                ...
                default:
                    ...
                    if ($this->my->id != 0 || COwnerHelper::isCommunityAdmin()) {
                        ...
                        if ($task != 'newalbum' && $task != 'editAlbum' && $task != 'display') {
         ...
         * @return mixed
         */
        public function getAllAlbumData($sortBy = 'date') {
            $albumsData['data'] = $this->model->getAllAlbums($this->my->id, 0, $sortBy);
