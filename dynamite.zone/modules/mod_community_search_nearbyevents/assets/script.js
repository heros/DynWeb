...
S.prototype.search = function() {
    ...
    url = root.joms_mod_community_search_nearbyevents_url || '';
...
S.prototype.mapload = function( callback ) {
    ...
    root.joms_mod_community_search_nearbyevents_cb = function() {
        callback();
        root.joms_mod_community_search_nearbyevents_cb = undefined;
    }

    script = document.createElement( 'script' );
    script.type = 'text/javascript';
    script.src = '//maps.googleapis.com/maps/api/js?libraries=places&callback=joms_mod_community_search_nearbyevents_cb';
