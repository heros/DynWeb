<?php
    ...
    $oldPhotos = $model->getAllPhotos(null, PHOTOS_USER_TYPE, $default, 0, COMMUNITY_ORDER_BY_DESC,
        COMMUNITY_ORDERING_BY_CREATED);

    $latestPhotos = array_merge($oldPhotos,$latestPhotos);
    ...
    require(JModuleHelper::getLayoutPath('mod_community_photos', $params->get('layout', 'default')));
