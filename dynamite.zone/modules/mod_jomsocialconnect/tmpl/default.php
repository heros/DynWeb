...
?>
    ...
    <fb:login-button autologoutlink="false" onlogin="joms.api.fbcUpdate();" scope="read_stream,publish_actions,email,user_birthday,user_status"><?php echo JText::_('COM_COMMUNITY_SIGN_IN_WITH_FACEBOOK');?></fb:login-button>
<?php
    }
    else
    {
