...
abstract class KunenaForum
{
	...
	protected static function buildVersion()
	{
		...
		{
			self::$version = strtoupper ( '4.0.3' );
		}

		self::$version_major = substr(self::$version, 0, 3);
		self::$version_date = ('2015-06-29' == '@' . 'kunenaversiondate' . '@') ? JFactory::getDate()->format('Y-m-d') : '2015-06-29';
		self::$version_name = ('Possagno' == '@' . 'kunenaversionname' . '@') ? 'Git Repository' : 'Possagno';
	}
}
